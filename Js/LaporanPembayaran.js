...
const htmldata = (res, no) => {
	...
	<td style="text-align: center;">
        <a href="/spt-project/pembayaran/${no_inv}" class="btn btn-danger text-bold delete"><i class="far fa-trash-alt"></i>&nbsp;Hapus</a>
        &nbsp;&nbsp;
        <a href="/spt-project/transaksi/pembayaran/cetak?inv=${res.no_invoice}" class="btn btn-success text-bold"><i class="fas fa-print"></i>&nbsp;Cetak</a>
        </td>
</tr>`;
};
