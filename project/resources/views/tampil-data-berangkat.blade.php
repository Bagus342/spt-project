...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="/spt-project/berangkat/view/cetak" class="btn btn-primary float-right text-bold ml-1"><i class="fas fa-print"></i>&nbsp;Cetak Laporan</a>
            ...
            <form action="/spt-project/berangkat" method="post">
                @csrf
