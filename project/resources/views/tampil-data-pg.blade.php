                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        @if (session('role') === 2)
                                            <a href="/spt-project/pg/view/add" class="btn btn-success float-right text-bold"><i class="fas fa-plus"></i>&nbsp;Tambah</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    @if (session('role') === 2)
                                                        <td style="text-align: center;">
                                                            ...
                                                            <a href="/spt-project/pg/{{ $item->id_pg }}" class="btn btn-danger text-bold delete"><i class="far fa-trash-alt"></i>&nbsp;Hapus</a>
                                                        </td>
                                                    @endif
                                                </tr>
                                            @endforeach
