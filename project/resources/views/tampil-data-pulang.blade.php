                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="/spt-project/pulang/view/cetak" class="btn btn-primary float-right text-bold ml-1"><i class="fas fa-print"></i>&nbsp;Cetak Laporan</a>
                                        <a href="/spt-project/pulang/view/list" class="btn btn-success float-right text-bold"><i class="fas fa-plus"></i>&nbsp;Tambah</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-header -->
