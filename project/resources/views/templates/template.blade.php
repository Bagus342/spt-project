            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="/spt-project/auth/logout" class="dropdown-item dropdown-footer">Logout</a>
                    </div>
                </li>
            </ul>
        </nav>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="/spt-project/dashboard" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/spt-project/berangkat" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Keberangkatan</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/spt-project/pulang" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Kepulangan</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/spt-project/pembayaran" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pembayaran</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="/spt-project/transaksi/berangkat" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/spt-project/transaksi/pembayaran" class="nav-link">
                                <i class="nav-icon fas fa-file-invoice-dollar"></i>
                                <p>
                                    Laporan Pembayaran
                                    <!-- <span class="right badge badge-danger">New</span> -->
